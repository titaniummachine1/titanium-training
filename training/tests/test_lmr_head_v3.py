...
from experiments.lmr.train_lmr_head_v3 import (
    CONTEXT5_NAMES,
    HANDCRAFTED_RULES,
...
from experiments.lmr.collect_reduction_counterfactuals_v3 import (
    classify_phase,
...
class TestSealedHoldout(unittest.TestCase):
    ...
    def test_manifest_must_exist_before_holdout(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            from experiments.lmr.train_lmr_head_v3 import check_holdout_sealed
...
class TestFeatureExtraction(unittest.TestCase):
    ...
    def test_ablation_zeros_context_slot(self):
        from experiments.lmr.train_lmr_head_v3 import features_PL_ablation
...
class TestUnsafeWeighting(unittest.TestCase):
    ...
    def test_trunk_unchanged_after_training(self):
        from experiments.lmr.train_lmr_head_v3 import WEIGHTS
