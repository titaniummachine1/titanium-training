...
class FeatureParityTests(unittest.TestCase):
    ...
    def test_context5_normalization_move_index_boundary(self):
        from experiments.lmr.train_reduction_sidecar_v2 import get_features, VARIANTS
        row = make_row()
    ...
    def test_variant_B_zeros_move_index(self):
        from experiments.lmr.train_reduction_sidecar_v2 import get_features
        row = make_row()
        row["hidden32"] = [1.0] * 32
    ...
    def test_feature_schema_mismatch_detected_by_integrity(self):
        from experiments.lmr.train_reduction_sidecar_v2 import integrity_check
        bad_row = make_row()
...
class ThresholdSelectionTests(unittest.TestCase):
    ...
    def test_unsafe_constraint_enforced(self):
        from experiments.lmr.train_reduction_sidecar_v2 import select_threshold
    ...
    def test_lower_threshold_chosen_when_more_profitable(self):
        from experiments.lmr.train_reduction_sidecar_v2 import select_threshold, INFERENCE_COST_NODES
...
class ModelVariantBinaryPaddingTests(unittest.TestCase):
    ...
    def test_variant_C_padded_to_37_weights(self):
        from experiments.lmr.train_reduction_sidecar_v2 import write_binary, VARIANTS
        import tempfile, os
        model = nn.Linear(5, 1)
    ...
    def test_variant_D_padded_to_37_weights(self):
        from experiments.lmr.train_reduction_sidecar_v2 import write_binary
        import tempfile, os
...
class SignedEconomicsTests(unittest.TestCase):
    ...
    def _eval_stats(self, rows, threshold=0.05):
        import torch
        import torch.nn as nn
        from experiments.lmr.train_reduction_sidecar_v2 import evaluate_at_threshold
